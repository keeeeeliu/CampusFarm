...
def perform_action_based_on_next_delivery():
    try:
        ...
        print(f"Error in genDirtyPeriods/perform_action_based_on_next_delivery:\n {e}")
...
def make_account():
    ...
    try:
        ...
        print(f"Error in genDirtyPeriods/make_account:\n {e}")
...
def get_login_token():
    ...
    try:
        ...
        print(f"Error in genDirtyPeriods/get_login_token:\n {e}")
...
def get_moer(token):
    try:
        ...
        print(f"Error in genDirtyPeriods/get_moer:\n {e}")
...
def generate_dirty_periods(num_time_slots_wanted):
    ...
    # num_time_slots_wanted = get_amount_of_clean_periods()
        ...
        print(f"Error in genDirtyPeriods/generate_dirty_periods:\n {e}")
...
def plot_dirty_periods(dirty_periods, values, times):
    ...
    # Parse full ISO 8601 timestamps for start and end
        ...
        print(f"Error in genDirtyPeriods/plot_dirty_periods:\n {e}")
